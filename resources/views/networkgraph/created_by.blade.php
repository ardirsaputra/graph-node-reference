...
<html>
  ...
  <body>
    <div id="controls">
      ...
      | <a href="/networkgraph/referalid"><button type="submit" name="swith view" value="drag"><label for="mode-swich">User Referal Network Graph</label></a>
    </div>
